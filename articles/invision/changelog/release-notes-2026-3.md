...
Whether you want to enable the Toolbar, and which buttons to show, is configured in the Workbook Designer. You can also specify whether the toolbar is right or left aligned.

![img](/images/invision/release-notes-20263-worksheet-toolbars.png)
...
**Breaking change: Datagrid updated to lastest version (Handsontable v17)**  
...
**Breaking change: Removed support for LESS for theming and custom styling**  
