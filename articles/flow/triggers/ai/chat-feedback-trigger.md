...
![Chat Feedback Trigger](/images/flow/chat-feedback-trigger.png)

**Example**![Example](../../../../images/strz.jpg) The example above shows a Flow that receives a feedback and stores this to a database table. 
<br/>
...
![Aichat UI Example](/images/flow/AIChat-ui-example.png)

**Example**![Example](../../../../images/strz.jpg) The example above shows the [Invision AI Chat component](../../../invision/docs/ai-chat/overview.md) displaying two responses, each showing which feedback option was selected for that response. 
